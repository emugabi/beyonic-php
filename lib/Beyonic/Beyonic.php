...
class Beyonic
{
    ...
    public static $duplicateCheckKey = null;
    ...
    */
    ...
    /*
     * setDuplicateCheckKey - Sets a “Duplicate-Check-Key” header to requests
     */
    public static function setDuplicateCheckKey($duplicateCheckKey)
    {

        self::$duplicateCheckKey = $duplicateCheckKey;
    }
    ...
    */
    public static function sendRequest($endpoint, $method = 'GET', $id = null, $parameters = null)
    {
        ...
        if (self::$duplicateCheckKey != null)
            $httpHeaders[] = 'Duplicate-Check-Key: ' . self::$duplicateCheckKey;
